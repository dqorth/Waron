...
**Function: `_drawSelectedTileTooltip`**
```javascript
/**
   * One-line summary.
   * 
...
### File: `js/config/time-dilation.js`
...
**Function: `_findSettlementLocation`**
```javascript
/**
   * One-line summary.
   * 
...
**Function: `_getFoodCarryCapacity`**
```javascript
/**
   * One-line summary.
   * 
